...
|-----------|----------|----------|
| Blazor architecture, auth design, code review | Peter 🏗️ | System design, PR review, auth strategy, performance planning |
| Blazor UI / frontend | Blair ⚛️ | Razor components, Syncfusion, CSS, client-side auth UX, HttpClient calls |
| Azure Functions / API / security | Glenn 🔧 | Controllers, auth middleware, AutoMapper, DI, input validation |
| Firestore / Firebase / data models | Ray 📊 | Data modelling, repository implementation, Firebase Auth, query optimisation |
| Playwright / E2E tests / quality | Josh 🧪 | E2E scripts, auth flow tests, performance regression, page object models |
| Session logging | Scribe 📋 | Automatic — never needs routing |
| Work queue monitoring | Ralph 🔄 | Activate with "Ralph, go" |
